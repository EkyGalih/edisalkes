...
class PurchaseFormEdit(forms.ModelForm):
    ...
    class Meta:
        model = Purchases
        fields = ('invoice_no','transaction_date','vendor_name','dp','receiver_name','ongkos_kirim','nomor_surat_jalan','tax_persen')
...
class PurchaseDetailForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ("product_code","product_name","quantity","size","unit_price",)
