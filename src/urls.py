...
urlpatterns = [
    ...
    path('kas/besar/template/<str:pk>',KS.edittemplatekbKeluar, name="kasbesarKeluar_edit_template"),
    path('kas/besar/template/<str:pk>',KS.edittemplatekbMasuk, name="kasbesarMasuk_edit_template"),
]